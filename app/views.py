...
from app.utils import get_lat_lng_from_postcode_data, get_point_from_postcode_data


def view_stores(view_type: ViewType):
    bbox = get_bbox() if view_type is ViewType.MAP else None
    view_context = ViewContext(view_type=view_type.value, stores=get_stores(), bbox=bbox)
